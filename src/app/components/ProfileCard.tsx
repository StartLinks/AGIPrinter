...
interface ProfileCardProps {
    ...
    onUpdateNotePosition: (noteId: string, position: { x: number; y: number }) => void;
...
export default function ProfileCard({
    ...
    return (
        <div
            id="print-area"
            className=" w-[595px] h-[842px] flex flex-col items-center gap-8 bg-white relative"
        >
            <Image
                src="/Menu bar.svg"
                alt="Menu bar"
            ...
            <div className="flex items-center gap-5 px-6 w-full">
                <div className="flex gap-5 items-center">
                    <Image
                        src={data?.avatar || "https://cdn.bonjour.bio/static/image/defaultAvatar.svg"}
                        alt="Placeholder"
                        width={200}
                        height={200}
                    ...
                    <div className="flex flex-col gap-5 justify-around">
                        <div className="text-4xl font-bold font-fusion-pixel">{data?.name}</div>
